    ...
    <div className="flex min-h-screen bg-slate-50">
      ...
      `}>
        ...
        <nav className="flex flex-col gap-1 flex-1 relative z-10">
          ...
          {canSee([UserRole.Cuentas_Opera, UserRole.Cuentas_Lider, UserRole.Admin]) && <SidebarItem icon={<Icons.Clients />} label="Clientes / Archivo" active={view === 'clients'} isCollapsed={isCollapsed} onClick={() => { setView('clients'); setIsMobileMenuOpen(false); }} />}
